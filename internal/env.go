...
// 	}
// 	if err != nil {
// 		Logger.Warn("failed to read engine cache: ", err)
// 	}
...
// 		Logger.Debug("no engine checks")
// 	} else {
// 		Logger.Info("engine checks:")
// 		for _, engine := range env.Engines {
// 			Logger.Info(engine.Name, " version ", engine.ExpectedVersion)
// 			if engine.OK {
// 				Logger.Info("OK")
// 			} else {
// 				Logger.Error("ERROR: actual version ", engine.ActualVersion)
// 			}
// 		}
// 	}
// }
